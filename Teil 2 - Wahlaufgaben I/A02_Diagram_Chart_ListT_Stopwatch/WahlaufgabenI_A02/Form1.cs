...
namespace WahlaufgabenI_A02
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            this.Text = "A02_Diagram chart, List<T>, Stopwatch";
        ...
        private void Start_button_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //Zeit liegt außerhalb des gewerteten Bereichs
                ...
                //Zeit liegt innerhalb des gewerteten Bereichs
                else
                {
                    zeiten.Add(z_round);
                }
                ...
                #region Zeichnen
                ergebnis_chart.Series.Clear(); //Diagramm bereinigen
               
                //Zeiten der Liste ins Diagramm eintragen
                for (double i = 2.4; i < 3.7; i = i + 0.1)
                {
                    i = Math.Round(i, 1);
